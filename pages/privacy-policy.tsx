    ...
    <Layout title='Privacy Policy' description='Privacy policy of tooot app'>
      ...
      <ul className='list-disc list-inside'>
        <li>
          ...
          such as taps on buttons are collected anonymously for the purpose of
          improving functionality. You can choose to opt-out of this collection
          in the app's settings.
        </li>
        <li>
          <strong>App performance information:</strong> Such as app crashes
          information are collected for the purpose of improving app stability.
        </li>
      </ul>
